...
TARGET = $(TARGETDIR)/libglew.a
OBJDIR = ../obj/Release/Release/glew
...
GENERATED += $(OBJDIR)/glewinfo.o
GENERATED += $(OBJDIR)/visualinfo.o
OBJECTS += $(OBJDIR)/glew.o
OBJECTS += $(OBJDIR)/glewinfo.o
OBJECTS += $(OBJDIR)/visualinfo.o
...
$(OBJDIR)/glew.o: glew/src/glew.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/glewinfo.o: glew/src/glewinfo.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/visualinfo.o: glew/src/visualinfo.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
